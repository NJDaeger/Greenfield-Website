            ...
            <div className="w-100 h-100 position-absolute top-0 d-flex align-items-center flex-column overflow-scroll pt-5">
                ...
                <div className="d-flex flex-column col-10 text-white justify-content-center flex-xl-row align-items-center">
                    ...
                    <div className="d-block col-10 col-xl-5 m-5 p-4 condition-section" id="#builder-conditions">
                        <h3 className="text-center d-flex flex-row">Build Member Conditions<Button text="*" outerClass={"asterisk"} dataType="glass clear" click={() => {setShowMsg2(true)}}></Button></h3>
                        <hr />
                        <div>
                        ...
                        <div>
                            ...
                            <span className="ms-3 mb-0 li">Any media that is purposefully created to be used as official<Button text="*" outerClass={"asterisk d-inline-flex"} dataType="glass clear" click={() => {setShowMsg3(true)}}></Button>
                                promotional material for the project is owned by the Greenfield Minecraft Project. Any other media that is not official is owned by the creator of said media.</span>
                        </div>
                    </div>
                </div>
            </div>
